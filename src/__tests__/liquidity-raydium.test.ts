...
const tests = {
  ...
  ADD: [
    {
      signature:
        "4zFeXoUVaaQ18chkY899hvvTYBRMAJ6CaNfWxbchMDDEY1L56maqwAdY19Faif5LBoTxwBPeEamcEsh76b39fjia",
      type: "ADD",
  ...
  REMOVE: [
    {
      signature:
        "2MvpoPWEY3gnEE5WxsQATRRa15Go6p8HxBbuxATiTUMxCRJeVQsBCPnCRdrM5YModikwpTiKu1iZbPBeTdHkg3uv",
      type: "REMOVE",
      desc: "Singer > Raydium Liquidity Pool V4: raydium:add-liquidity",
      name: "CAR",
      poolId: "Bx5pAzBqbuYH5yT93XCoShDka6d6vz9AzBddG7zE9syh",
